function [Fnet,Mnet] = netforcemoment(guess,buoyantdistfunction,selfWeightInterp,xInterp,xUnique,paddlers)
...
%   Detailed explanation goes here
    ...
    Fnet = cumtrapz(xInterp,netForceDist) + sum(paddlers(:,2));
